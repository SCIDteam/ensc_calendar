...
export const calendar_courses = {
  ...
  2: [
    ...
    "3 Credits of Tools Electives",
    "One 200-level BIOL_V OR CHEM_V Course",
  ...
  "3/4": [
    ...
    "ENVR_V 450",
    "EOSC_V 345",
    ["ENVR_V 410", "ENVR_V 420", "ENVR_V 430", "ENVR_V 440"],
    "18 Credits of Area of Concentration Courses",
...
export const aoc_courses = {
  law: {
    ...
    required: ["ENVR_V 420", "EOSC_V 211"],
    oneOf: [
      ["APBI_V 200", "ATSC_V 201", "EOSC_V 220", "EOSC_V 221", "EOSC_V 222", "EOSC_V 270", "GEOS_V 200", "GEOS_V 206"]
    ],
    fiveOf: [
      "CHEM_V 310", "CHEM_V 302", "GEOS_V 300", "GEOS_V 304", "GEOS_V 305", "GEOS_V 308", "GEOS_V 309",
  ...
  energy: {
    ...
    oneOf: [
      ["ARCL_V 309", "ASIC_V 220", "CONS_V 425", "DES_V 230", "ENVR_V 430", "GEOG_V 310", "ISCI_V 360", "POLI_V 351", "POLI_V 375A", "SCIE_V 420", "SOCI_V 230"]
    ],
    fourOf: [
  ...
  health: {
    ...
    required: ["SPPH_V 303"],
    threeOf: [
      "BIOL_V 200", "BIOL_V 201", "BIOC_V 202", "CHEM_V 203", "CHEM_V 205", "CHEM_V 233", "MICB_V 211"
    ],
    fourOf: [
      "BIOL_V 302", "BIOL_V 314", "BIOL_V 328", "BIOL_V 403", "CHEM_V 302", "CHEM_V 341", "CIVL_V 201", "EOSC_V 474",
      "GEOS_V 402", "MECH_V 411", "SPPH_V 301"
    ]
  },
  analytics: {
    title: "Environmental Analytics",
    required: ["CPSC_V 203", "EOSC_V 410"],
    oneOf: [
      ["CPSC_V 103", "EOSC_V 211"]
    ],
    fiveOf: [
      "ATSC_V 409", "BIOL_V 301", "CPSC_V 330", "CPSC_V 430", "DSCI_V 310", "DSCI_V 320", "DSCI_V 430", "EOSC_V 250",
      "EOSC_V 354", "EOSC_V 440", "EOSC_V 471", "FRE_V 326", "FRE_V 474", "FRE_V 490", "GEOS_V 370",
