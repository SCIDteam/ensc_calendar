import { calendar_courses, aoc_courses, yearMapping, tools_electives } from './honours_courses.js';
import { openToolsPopup, openAocPopup, openCompStudiesPopup, openColumnPopup } from './popups copy.js';
...
function renderAocCourses(key, container) {
  ...
  if (Array.isArray(area.fiveOf) && area.fiveOf.length > 0)
    columnsContainer.appendChild(createColumn('Choose Five of the Following', area.fiveOf));
